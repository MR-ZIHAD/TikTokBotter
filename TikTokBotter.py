...
init()
system("mode 800")
system("title TikTok Botter -By MR-ZIHAD")
...
║          {color(">", "green")} Updates: {Fore.LIGHTMAGENTA_EX}Error Fix & Adjustment --30/10/2022{Fore.WHITE}                          ║
║          {color(">", "green")} Made By: {Fore.LIGHTMAGENTA_EX}MR-ZIHAD{Fore.WHITE}                                                ║
║          {color(">", "green")} Github: {Fore.LIGHTMAGENTA_EX}https://github.com/MR-ZIHAD{Fore.WHITE}                             ║
...
""")
    ...
    def refresh():
        system("cls")
        printing.text()
        align(f"\n\n\t\t\t{color('>', 'green')} Made By: {Fore.LIGHTMAGENTA_EX}MR-ZIHAD {color('<', 'green')}")
        align(f"\t\t\t\t{color('>', 'green')} {Fore.LIGHTGREEN_EX}Github: {Fore.LIGHTMAGENTA_EX}https://github.com/MR-ZIHAD/TikTokBotter {color('<', 'green')}")
        printing.options()
